...
classifier.addDenseLayer(shape=[30,50],activation="relu")
classifier.addDenseLayer(shape=[30,30],activation="relu")
classifier.addDenseLayer(shape=[20,30],activation="relu")
classifier.addDenseLayer(shape=[20,20],activation="relu")
classifier.addDenseLayer(shape=[10,20],activation="relu")
classifier.addDenseLayer(shape=[10,10],activation="relu")
classifier.addDenseLayer(shape=[10,10],activation="relu")
classifier.addDenseLayer(shape=[10,10],activation="softmax")
